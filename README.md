...
|---|---|
| `OPENAI_API_KEY` | OpenAI key used for both passes and for the product-lookup web search |
| `AGENT_GENERATE_MODEL` | Model for the drafting pass (default `gpt-4.1-mini`); must support OpenAI's `web_search` tool |
